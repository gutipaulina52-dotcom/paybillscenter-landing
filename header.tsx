  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <div className={`transition-all duration-300 ${hovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none'}`}>
        <div className="bg-white text-[#0a1628] text-sm font-semibold px-4 py-2 rounded-2xl shadow-xl whitespace-nowrap border border-slate-100">
      ...
      <a href="https://wa.me/17869972761?text=Hello!%20I%20need%20help%20paying%20my%20bills."
        ...
        className="relative w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 hover:scale-110 transition-all">
        {/* Pulse rings */}
